...
class SpeculativeConfig:
    ...
    def maybe_create_spec_config(
        ...
        rsd_map: Optional[Dict] = None,
        rsd_draft_model = None,
        rsd_target_model = None,
        ...
        return SpeculativeConfig(
            ...
            rsd=rsd,
            rsd_map=rsd_map,
            rsd_target_model=rsd_target_model,
            rsd_draft_model=rsd_draft_model,
            specinfer=specinfer,
    ...
    def __init__(
        ...
        Args:
            ...
            ssd: Whether to use Step-Level Speculative Decoding(AdaSpec without draft token elimination).
            rsd: Whether to use Request-Level Speculative Decoding(AdaSpec with draft token elimination).
            specinfer: Whether to use SpecInfer*(simulate SpecInfer without tree attetion due to implementation of PageAttention).
            assistant_confidence_threshold: The confidence threshold for the draft model to stop.
        """
        ...
        self.ssd = ssd
        self.rsd = rsd
        self.rsd_map = rsd_map
        self.rsd_draft_model = rsd_draft_model
        self.rsd_target_model = rsd_target_model
